...
/* Invalid selector '$(".navbar-toggle").click(function(t) {
...
function extraNavFuncs()' at 3:4. Ignoring. */
/* Invalid selector '$(".site-navigation a").click(function(t) {
...
function setFillScreenBlocHeight()' at 38:4. Ignoring. */
/* Invalid selector '$(".bloc-fill-screen").each(function(t) {
        var e = $(this);
...
function getFillHeight()' at 48:4. Ignoring. */
/* Invalid selector 'var t = $(window).height();
    return t < fillBodyHeight && (t = fillBodyHeight + 100), t


function scrollToTarget(t)' at 57:4. Ignoring. */
/* Invalid property name '1 == t ? t = 0' at 62:4. Ignoring. */
/* Invalid selector 'hideAll(), inViewCheck(), $(window).scroll(function() {
        inViewCheck(), scrollToTopView(), stickyNavToggle()
    })


function setUpDropdownSubs()' at 68:4. Ignoring. */
/* Invalid selector '$("ul.dropdown-menu [data-toggle=dropdown]").on("click", function(t) {
...
function stickyNavToggle()' at 74:4. Ignoring. */
/* Invalid selector 'var t = 0,
        e = "sticky";
...
function hideAll()' at 82:4. Ignoring. */
/* Invalid selector '$(".animated").each(function(t) {
        $(this).closest(".hero").length || $(this).removeClass("animated").addClass("hideMe")
    })


function inViewCheck()' at 92:4. Ignoring. */
/* Invalid selector '$($(".hideMe").get().reverse()).each(function(t) {
        var e = jQuery(this),
...
function scrollToTopView()' at 98:4. Ignoring. */
/* Invalid property name '$(window).scrollTop() > $(window).height() / 3 ? $(".scrollToTop").hasClass("showScrollTop") || $(".scrollToTop").addClass("showScrollTop")' at 112:4. Ignoring. */
/* Invalid selector '$(document).on("click", "[data-toggle-visibility]", function(t) {
        t.preventDefault();
...
function setUpLightBox()' at 116:4. Ignoring. */
/* Invalid selector 'window.targetLightbox, $(document).on("click", "[data-lightbox]", function(t) {
...
function addSwipeSupport()' at 133:4. Ignoring. */
/* Invalid selector '$(".carousel-inner").length && $(".carousel-inner").swipe({
...
function addKeyBoardSupport()' at 163:4. Ignoring. */
/* Invalid selector '$(window).keydown(function(t) {
        37 == t.which ? $(".prev-lightbox").is(":visible") && $(".prev-lightbox").click() : 39 == t.which && $(".next-lightbox").is(":visible") && $(".next-lightbox").click()
    })


function addLightBoxSwipeSupport()' at 175:4. Ignoring. */